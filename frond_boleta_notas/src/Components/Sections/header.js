    ...
    return(
        ...
        <div className=" relative pt-6 px-4 sm:px-6 lg:px-8 border-b-4 border-solid">
          ...
          <a href="#" className="absolute left-0">
            ...
            <a href="/" className="font-medium text-gray-500 hover:text-gray-900">Inicio</a>
              <a href="/planes" className="font-medium text-gray-500 hover:text-gray-900">Planes</a>
